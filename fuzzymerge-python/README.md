...
2. <a name="helper_functions"><b>1-helper_functions.py</b><br>
...
3. <a name="cleaning_functions"><b>2-cleaning_functions.py</b><br>
...
4. <a name="merge_functions"><b>3-merge_functions.py</b><br>
...
5. <a name="merge_steps"><b>4-merge_steps.py</b><br>
